            ...
            <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="pekerjaan_ayah" id="pekerjaan_ayah" class="form-control" value="{{ old('pekerjaan_ayah', $biodata->pekerjaan_ayah ?? '') }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="pekerjaan_ibu" id="pekerjaan_ibu" class="form-control" value="{{ old('pekerjaan_ibu', $biodata->pekerjaan_ibu ?? '') }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
