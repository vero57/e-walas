...
<head>
  ...
  <title>E Walas SMKN 1 Cibinong - Profile Kurikulum</title>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
        <h1 class="mb-4 text-center">
            Profile Kurikulum <br>
            <span class="accent-text">Berikut adalah Profile dari Kurikulum</span>
        </h1>

        <div class="walas-info-container">
    <!-- Foto Besar dan Icon Edit -->
    <div class="walas-photo-container position-relative">
        <img src="{{ asset('storage/'.$kurikulum->image_url) }}" alt="Image" class="walas-photo">
        <div class="edit-icon">
   ...
   <!-- Informasi Profile -->
    <div class="profile-info-container">
        ...
        <!-- Tombol Edit -->
         <br>
         <a href="{{ route('profilekurikulum.edit', $kurikulum->id) }}" class="edit-button" style="margin-right: 10px;">Edit Data</a>
         <a href="/kurikulumpage" class="kembali-button">Kembali</a>
