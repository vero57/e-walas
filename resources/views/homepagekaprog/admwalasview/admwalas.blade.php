        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                     ...
                     <a href="{{ route('admwalas.identitaskelas') }}?walas_id={{ $walas->id }}">
            ...
            <tr>
                ...
                <td>
                     <!-- Link untuk mengarahkan ke halaman dengan walas_id -->
                     <a href="{{ route('admwalas.lembarpengesahan') }}?walas_id={{ $walas->id }}">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('admwalas.strukturorganisasikelas') }}?walas_id={{ $walas->id }}">
            ...
            <tr>
                ...
                <td>Jadwal KBM</td>
                <td>
                    <a href="{{ route('admwalas.jadwalkbm') }}?walas_id={{ $walas->id }}">
            ...
            <tr>
                ...
                <td>
                    <!-- Link untuk mengarahkan ke halaman dengan walas_id -->
                    <a href="{{ route('admwalas.agendawalas') }}?walas_id={{ $walas->id }}">
