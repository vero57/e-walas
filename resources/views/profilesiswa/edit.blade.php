...
<form action="{{ route('profilesiswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="teacherName" name="nama" value="{{ old('nama', $siswa->nama) }}" required>
    </div>
    <div class="mb-3">
        ...
        @if($siswa->image_url)
            <div class="mt-2">
                <img src="{{ asset('storage/' . $siswa->image_url) }}" alt="Foto Wali Kelas" class="img-thumbnail" style="width: 150px;">
            </div>
        @endif
    </div>
    <div class="mb-3">
        <label for="teacherWhatsApp" class="form-label">WhatsApp</label>
        <input type="number" class="form-control" id="teacherWhatsApp" name="no_wa" value="{{ old('no_wa', $siswa->no_wa) }}" required>
    </div>
    <div class="mb-3">
