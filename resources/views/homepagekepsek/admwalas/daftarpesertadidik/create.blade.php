        ...
        <div class="mb-4">
            ...
            <div class="container mt-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                    <form action="{{ route('daftarpesertadidik.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!-- Wali Kelas -->
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="nis" id="nis" class="form-control" required readonly>
                                </div>

                                <!-- NISN -->
                                <div class="mb-3">
                                    <label for="nisn" class="form-label">NISN:</label>
                                    <input type="number" name="nisn" id="nisn" class="form-control" required readonly>
                                </div>
