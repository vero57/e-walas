...
<main class="main">
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            ...
            <div class="d-flex align-items-center justify-content-start">
                <a href="{{ route('beritaacarakelulusan.create') }}" class="btn btn-primary me-2 mb-2">
                    <i class="bi bi-plus"></i> Tambah
                </a>
                    <a href="{{ route('beritaacarakelulusan.index', ['export' => 'pdf']) }}" class="btn btn-outline-secondary me-2 mb-2">
    ...
    <div class="container">
    <h2>Daftar Berita Acara Kelulusan</h2>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            @foreach ($beritaAcaraKelulusan as $item)
            <tr>
                ...
                <td>
                    <a href="{{ route('beritaacarakelulusan.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
                </td>
            </tr>
            @endforeach
        </tbody>
