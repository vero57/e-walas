...
<main class="main">
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            <h2 class="font-weight-bold">Form Rekapitulasi Jumlah Siswa</h2>
            ...
            <div class="container mt-4">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Formulir Rekapitulasi Jumlah Siswa</h3>
                                    </div>
                                    <div class="card-body">
                                    <form action="{{ route('rekapjumlahsiswa.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!-- Wali Kelas -->
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="bulan" id="bulan" class="form-select" required>
                                        ...
                                        <option value="Desmber">Desmber</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="jumlah_awal_siswa" id="jumlah_awal_siswa" class="form-control" required >
                                </div>

                                <!-- NISN -->
                                <div class="mb-3">
                                    <label for="jumlah_akhir_siswa" class="form-label">Jumlah Akhir:</label>
                                    <input type="number" name="jumlah_akhir_siswa" id="jumlah_akhir_siswa" class="form-control" required>
                                </div>
