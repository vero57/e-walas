...
<main class="main">
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            <h2 class="font-weight-bold">Rekapitulasi Jumlah Peserta Didik</h2>
            ...
            <div class="d-flex align-items-center justify-content-start">
                ...
                <a href="/rekapjumlahsiswacreate" class="btn btn-primary me-2 mb-2">
                    <i class="bi bi-plus"></i> Tambah
                </a>
                <a href="{{ route('rekapjumlahsiswa.index', ['export' => 'pdf']) }}" class="btn btn-outline-secondary me-2 mb-2">
    ...
    <h4>Rekapitulasi Jumlah Peserta Didik</h4>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            @forelse ($rekapjumlahsiswa ?? [] as $idx => $data)
                <tr>
                    <td>{{ $idx + 1 }}</td>
                    <td>{{ $data->bulan }}</td>
                    ...
                    <td class="text-center" colspan="2">
                        <div class="d-flex justify-content-center">
                            <!-- Tombol Edit -->
                            <a href="{{ route('rekapjumlahsiswa.edit', $data->id) }}" class="btn btn-primary btn-sm me-2">Edit</a>
                            <!-- Tombol Delete -->
                            <a href="/hapusrekapjumlahsiswa/{{$data->id}}" class="btn btn-danger btn-sm">Hapus</a>
                        </div>
                    </td>
                </tr>
            @empty
