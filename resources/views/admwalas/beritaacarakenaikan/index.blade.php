...
<main class="main">
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            <h2 class="font-weight-bold">Berita Acara Kenaikan Kelas</h2>
            <hr class="my-3"> <!-- Garis horizontal di bawah judul -->
            <div class="d-flex align-items-center justify-content-start">
                <a href="{{ route('beritaacarakenaikan.create') }}" class="btn btn-primary me-2 mb-2">
                    <i class="bi bi-plus"></i> Tambah
                </a>
                    <a href="{{ route('beritaacarakenaikan.index', ['export' => 'pdf']) }}" class="btn btn-outline-secondary me-2 mb-2">
    ...
    <div class="container">
    <h2>Daftar Berita Acara Kenaikan</h2>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->walas->nama ?? 'N/A' }}</td>
                <td>{{ \Carbon\Carbon::parse($item->waktu_tanggal)->format('d-m-Y') }}</td>
                <td>{{ $item->tempat }}</td>
                <td>{{ $item->rombel->nama_kelas }}</td>
                <td>{{ $item->kelas_baru }}</td>
                <td>{{ $item->jumlah_peserta_rapat }}</td>
                <td>
                    <a href="{{ route('beritaacarakenaikan.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
                </td>
            </tr>
            @endforeach
        </tbody>
