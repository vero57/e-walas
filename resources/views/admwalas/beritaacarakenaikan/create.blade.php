...
<main class="main">
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            <h2 class="font-weight-bold">Form Pengisian Berita Acara Kenaikan Kelas</h2>
    ...
    <form action="{{ route('beritaacarakenaikan.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="kelas_baru" class="form-control">
        </div>

        <div class="mb-3">
            <label for="laki_laki_naik" class="form-label">Laki-laki Naik</label>
            <input type="text" name="laki_laki_naik" class="form-control" maxlength="5">
        </div>

        <div class="mb-3">
            <label for="perempuan_naik" class="form-label">Perempuan Naik</label>
            <input type="text" name="perempuan_naik" class="form-control" maxlength="5">
        </div>

        <div class="mb-3">
            <label for="laki_laki_tinggal" class="form-label">Laki-laki Tinggal</label>
            <input type="text" name="laki_laki_tinggal" class="form-control" maxlength="5">
        </div>

        <div class="mb-3">
            <label for="perempuan_tinggal" class="form-label">Perempuan Tinggal</label>
            <input type="text" name="perempuan_tinggal" class="form-control" maxlength="5">
        </div>
