...
<main class="main">
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            ...
            <div class="d-flex align-items-center justify-content-start">
                ...
                <a href="/agendawalascreate" class="btn btn-primary">
    ...
    <h4>Daftar Agenda Kegiatan Walas</h4>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            @forelse ($agendawalas ?? [] as $idx => $data)
                <tr>
                    <td>{{ $idx + 1 }}</td>
                    <td>{{ $data->hari }}</td>
                    <td>{{ $data->tanggal }}</td>
                    ...
                    <td class="text-center" colspan="2">
                        <div class="d-flex justify-content-center">
                            <!-- Tombol Edit -->
                            <a href="{{ route('agendawalas.edit', $data->id) }}" class="btn btn-primary btn-sm me-2">Edit</a>
                            <!-- Tombol Delete -->
                            <a href="/hapusagendawalas/{{$data->id}}" class="btn btn-danger btn-sm">Hapus</a>
                        </div>
                    </td>
                </tr>
            @empty
