...
<main class="main">
    ...
    <div class="starter-section container">
        ...
        <div class="mb-4">
            <h2 class="font-weight-bold">Daftar Penyerahan Rapot</h2>
            ...
            <div class="card">
    <div class="card-header">Edit Daftar Penyerahan Rapot</div>
    <div class="card-body">
        <form action="{{ route('penyerahanrapot.update', $penyerahanrapot->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
           ...
           <!-- Wali Kelas -->
                ...
                <select name="walas_id" id="walas_id" class="form-select" required>
                    @foreach($walas as $walas_item)
                        <option value="{{ $walas_item->id }}" 
                            {{ $penyerahanrapot->walas_id == $walas_item->id ? 'selected' : '' }}>
                            {{ $walas_item->nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <!-- Foto -->
            <div class="mb-3">
                <label for="image_url" class="form-label">Unggah Dokumen:</label>
