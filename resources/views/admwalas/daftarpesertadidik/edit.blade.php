      ...
      <form action="{{ route('logoutwalas') }}" method="POST">
                            ...
                            <main class="main">
                                ...
                                <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <div class="mb-4">
                                        <h2 class="font-weight-bold">Form Catatan Kasus Siswa</h2>
                                        ...
                                        <div class="container mt-4">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <h3>Formulir Daftar Peserta Didik</h3>
                                                                </div>
                                                                <div class="card-body">
                                                                <form action="{{ route('daftarpesertadidik.update', $daftarPesertaDidik->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <input type="hidden" name="kurikulum_id" value="{{ $kurikulumIdPertama }}">
                               ...
                               <!-- Siswa -->
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="nis" id="nis" class="form-control" required readonly value="{{ $daftarPesertaDidik->nis }}">
                                </div>

                                <!-- NISN -->
                                <div class="mb-3">
                                    <label for="nisn" class="form-label">NISN:</label>
                                    <input type="number" name="nisn" id="nisn" class="form-control" required readonly value="{{ $daftarPesertaDidik->nisn }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-select" required>
                                        ...
                                        <option value="Laki-laki" @if($daftarPesertaDidik->jenis_kelamin == 'Laki-laki') selected @endif>Laki-laki</option>
                                        <option value="Perempuan" @if($daftarPesertaDidik->jenis_kelamin == 'Perempuan') selected @endif>Perempuan</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="keterangan" id="keterangan" class="form-control" required>{{ $daftarPesertaDidik->keterangan }}</textarea>
                                </div>

                                <!-- Tanggal -->
                                <div class="mb-3">
                                    <label for="tanggal" class="form-label">Tanggal Input:</label>
                                    <input type="date" name="tanggal" id="tanggal" class="form-control" required value="{{ $daftarPesertaDidik->tanggal }}">
                                </div>
