...
<main class="main">
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-start">
                ...
                <!-- Tombol Tambah Data -->
                <a href="/daftarpesertadidikcreate" class="btn btn-primary me-2 mb-2">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            @forelse ($daftarpdidik ?? [] as $idx => $data)
                <tr>
                    <td>{{ $idx + 1 }}</td>
                    ...
                    <td class="text-center" colspan="2">
                        <div class="d-flex justify-content-center">
                            <!-- Tombol Edit -->
                            <a href="{{ route('daftarpesertadidik.edit', $data->id) }}" class="btn btn-primary btn-sm me-2">Edit</a>
                            <!-- Tombol Delete -->
                            <a href="/hapusdaftarpesertadidik/{{$data->id}}" class="btn btn-danger btn-sm">Hapus</a>
                        </div>
                    </td>
                </tr>
            @empty
    ...
    <br>
    <!-- Menampilkan Jumlah Jenis Kelamin -->
    <div class="row mb-3">
        <div class="col d-flex flex-column align-items-center justify-content-center">
            <p class="font-weight-bold text-primary" style="font-size: 1.2rem;"><strong>Jumlah Laki-laki: {{ $jenisKelaminCount['Laki-laki'] ?? 0 }}</strong></p>
        </div>
        <div class="col d-flex flex-column align-items-center justify-content-center">
            <p class="font-weight-bold text-danger" style="font-size: 1.2rem;"><strong>Jumlah Perempuan: {{ $jenisKelaminCount['Perempuan'] ?? 0 }}</strong></p>
        </div>
    </div>
@endif
