...
<main class="main">
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            <h2 class="font-weight-bold">Form Berita Acara Serah Terima</h2>
        ...
        <div class="container mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3>Formulir Berita Acara Serah Terima</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('beritaacaraserahterima.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <!-- Wali Kelas -->
                            <div class="mb-3">
