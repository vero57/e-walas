...
<main class="main">
    ...
    <div class="starter-section container">
        ...
        <div class="mb-4">
            <h2 class="font-weight-bold">Edit Berita Acara Serah Terima</h2>
            ...
            <div class="card">
    <div class="card-body">
        <form action="{{ route('beritaacaraserahterima.update', $beritaacaraserahterima->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <select name="walas_id" id="walas_id" class="form-select" required>
                        <option value="{{ $walaslogin->id }}" 
                                {{ $beritaacaraserahterima->walas_id == $walaslogin->id ? 'selected' : '' }}>
                            {{ $walaslogin->nama }}
                        </option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                @if($beritaacaraserahterima->image_url)
                    <img src="{{ asset('storage/'.$beritaacaraserahterima->image_url) }}" class="mt-2" style="width: 150px; height: 150px; object-fit: cover;">
                @endif
            </div>
