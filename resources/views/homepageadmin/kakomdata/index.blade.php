...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="/adminpage" class="logo d-flex align-items-center me-auto me-xl-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Kembali ke Home Page">
      ...
      <nav id="navmenu" class="navmenu">
        ...
        <li><a href="/wargasekolah" data-bs-toggle="tooltip" data-bs-placement="top" title="Beranda">Beranda</a></li>
          <li><a href="/walas" data-bs-toggle="tooltip" data-bs-placement="top" title="Wali Kelas">Wali Kelas</a></li>
          <li><a href="/guru" data-bs-toggle="tooltip" data-bs-placement="top" title="Guru">Guru</a></li>
          <li><a href="/kakom"class="active" data-bs-toggle="tooltip" data-bs-placement="top" title="Kepala Kompetensi">Kepala Kompetensi</a></li>
          <li><a href="/kurikulum" data-bs-toggle="tooltip" data-bs-placement="top" title="Kurikulum">Kurikulum</a></li>
          <li><a href="/kepalasekolah" data-bs-toggle="tooltip" data-bs-placement="top" title="Kepala Sekolah">Kepala Sekolah</a></li>
        </ul>
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            ...
            <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                    ...
                    <form action="{{ url('kakom_search') }}" method="GET">
                        <div class="input-box">
                            <i class="uil uil-search"></i>
                                <input type="text" name="keyword" placeholder="Cari Kepala Kompetensi..." value="{{ old('keyword', $keyword ?? '') }}" required />
        ...
        <div class="table-container">
            ...
            <tr>
                ...
                <div style="display: flex; gap: 5px; justify-content: center; flex-wrap: wrap;">
                   <!-- Tombol Edit -->
                   <a href="{{ route('kakom.edit', $data->id) }}" class="btn btn-primary btn-sm me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Data Kakom">
                        Edit
                    </a>
                    <!-- Tombol Delete -->
                    <a href="/hapuskakom/{{$data->id}}" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus data kakom">Hapus</a> 
                </td>
                </div>
            </tr>
        @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Form Unggah Data -->
                <form action="/kakom-import" method="post" enctype="multipart/form-data" id="uploadKakomForm">
                    @csrf
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="uploadKakomButton">Unggah</button>

                <!-- Spinner Loading -->
                <div id="loadingSpinnerKakom" class="d-none">
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('kakom.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="kakomName" class="form-label">Nama Kepala Kompetensi</label>
                        <input type="text" class="form-control" id="kakomName" placeholder="Masukkan Nama Kepala Kompetensi" name="nama" required>
                    </div>
                    <div class="mb-3">
                        <label for="kakomWhatsApp" class="form-label">WhatsApp</label>
                        <input type="number" class="form-control" id="kakomWhatsApp" placeholder="Masukkan nomor WhatsApp" name="no_wa" required>
                    </div>
                    <div class="mb-3">
                        <label for="kakomPassord" class="form-label">Password</label>
                        <input type="password" class="form-control" id="kakomPassord" placeholder="Masukkan Password" name="password" required>
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Pilih Kompetensi</label>
...
<script>
    document.getElementById("uploadKakomForm").addEventListener("submit", function(event) {
        // Sembunyikan tombol unggah, tampilkan spinner
        document.getElementById("uploadKakomButton").classList.add("d-none");
        document.getElementById("loadingSpinnerKakom").classList.remove("d-none");
    });
</script>
