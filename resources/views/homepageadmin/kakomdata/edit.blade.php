...
<form action="{{ route('kakom.update', $kakom->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT') <!-- Menyatakan bahwa ini adalah request PUT untuk update -->
    <div class="mb-3">
        <label for="teacherName" class="form-label">Nama Kakom</label>
        <input type="text" class="form-control" id="teacherName" name="nama" value="{{ old('nama', $kakom->nama) }}" required>
    </div>
    <div class="mb-3">
        ...
        @if($kakom->image_url)
            <div class="mt-2">
                <img src="{{ asset('storage/' . $kakom->image_url) }}" alt="Foto Kakom" class="img-thumbnail" style="width: 150px;">
            </div>
        @endif
    </div>
    <div class="mb-3">
        <label for="teacherWhatsApp" class="form-label">WhatsApp</label>
        <input type="number" class="form-control" id="teacherWhatsApp" name="no_wa" value="{{ old('no_wa', $kakom->no_wa) }}" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="teacherName" name="kompetensi" value="{{ old('kompetensi', $kakom->kompetensi) }}" required>
    </div>
    <div class="mb-3">
