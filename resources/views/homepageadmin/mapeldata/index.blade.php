...
<main class="main">
    ...
    <span class="text-muted">
        Jumlah Total: <strong>{{ $mapel->count() }} Mata Pelajaran</strong>
    </span>
</div>
            ...
            @forelse ($mapel as $data)
                <tr>
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('datamapel.edit', $data->id) }}" class="btn btn-primary btn-sm me-2">Edit</a>
                        <form action="{{ route('datamapel.destroy', $data->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
