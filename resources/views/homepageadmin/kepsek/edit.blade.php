...
<body>
  ...
  <div class="container mt-5">
    ...
    <h3>Form Edit Kepala Sekolah </h3>
    <br>
...
<form action="{{ route('kepsek.update', $kepsek->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        @if($kepsek->image_url)
            <div class="mt-2">
                <img src="{{ asset('storage/' . $kepsek->image_url) }}" alt="Foto Wali Kelas" class="img-thumbnail" style="width: 150px;">
            </div>
        @endif
    </div>
    <div class="mb-3">
        <label for="teacherWhatsApp" class="form-label">WhatsApp</label>
        <input type="number" class="form-control" id="teacherWhatsApp" name="no_wa" value="{{ old('no_wa', $kepsek->no_wa) }}" required>
    </div>
    <div class="mb-3">
