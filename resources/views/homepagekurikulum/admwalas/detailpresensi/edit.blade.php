...
<main class="main">
    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            <h1 class="font-weight-bold">Edit Detail Presensi</h1>
    ...
    <form action="{{ route('detailpresensi.update', [$presensi->id, $detail->id]) }}" method="POST">
        @csrf
        @method('PUT')
    ...
    <select name="siswas_id" id="siswas_id" class="form-control" required>
        @foreach($siswas as $siswa)
            <option value="{{ $siswa->id }}" 
                {{ old('siswas_id', isset($detail) ? $detail->siswas_id : null) == $siswa->id ? 'selected' : '' }}>
                {{ $siswa->nama }}
            </option>
        @endforeach
    </select>
        ...
        <div class="mb-3">
            ...
            <select name="status" id="status" class="form-control" required>
                ...
                <option value="alfa" {{ $detail->status == 'alfa' ? 'selected' : '' }}>Alfa</option>
            </select>
        </div>
