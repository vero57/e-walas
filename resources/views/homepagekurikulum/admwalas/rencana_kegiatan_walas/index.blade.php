    ...
    <div class="starter-section container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4">
            ...
            <div class="d-flex align-items-center justify-content-start">
                ...
                <a href="{{ route('rencana_kegiatan_walas.create', $semester) }}" class="btn btn-primary">
        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>{{ $item->walas ? $item->walas->nama : '-' }}</td>
                    <td>{{ $item->minggu_ke }}</td>
                    <td>{{ $item->kegiatan_bukti }}</td>
                    <td>{{ $item->keterangan }}</td>
                    <td>{{ $item->tanggalttd }}</td>
                    <td>
                    <a href="{{ route('rencana_kegiatan_walas.edit', [$semester, $item->id]) }}" class="btn btn-warning">Edit</a>
                        <form action="{{ route('rencana_kegiatan_walas.destroy', [$semester, $item->id]) }}" method="POST" style="display:inline-block;">
                            @csrf
                            @method('DELETE')
